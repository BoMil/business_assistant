  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<BottomNavigationCubit, BottomNavigationState>(
      listener: (context, state) {
        ...
        final isSelected = context.read<BottomNavigationCubit>().isTabSelected(
          RouteNames.accountPage,
        );
        if (isSelected &&
            userInfoCubit.state.currentState != CubitState.loaded) {
          userInfoCubit.loadUserInfo();
        }
      },
                  ...
                  CardFrame(
                    ...
                    child: ClipRRect(
                      ...
                      child: Column(
                        children: [
                          _AccountInfoRow(
                            title: t.accountNameLabel,
                            value: fullName,
                          ),
                          Divider(
                            height: 1,
                            color: theme.primaryText.withValues(alpha: 0.09),
                          ),
                          _AccountInfoRow(
                            title: t.email,
                            value: state.email ?? '',
                          ...
                          _AccountInfoRow(
                            title: t.accountContactNumberLabel,
