...
class TenantConfig {
  ...
  final String tenantId = const String.fromEnvironment('TENANT_ID', defaultValue: 'demo');

  /// Display name shown in the app bar, splash screen, etc.
  final String appName = const String.fromEnvironment('APP_NAME', defaultValue: 'Business Assistant');

  /// Android applicationId — must match what was used to sign the APK.
  final String packageName = const String.fromEnvironment('PACKAGE_NAME', defaultValue: 'com.businessassistant.demo');

  /// Path to the tenant's SVG logo inside the Flutter asset bundle.
  String get logoPath => 'assets/tenants/$tenantId/logo.png';

  /// ISO 4217 currency code shown next to prices (e.g. "EUR", "RSD").
  final String currency = const String.fromEnvironment('CURRENCY', defaultValue: 'EUR');

  /// What kind of business this tenant runs — see tenant_type.dart.
  static const String _tenantTypeRaw = String.fromEnvironment('TENANT_TYPE', defaultValue: 'Rental');
